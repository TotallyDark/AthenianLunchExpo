...
app = modal.App(name="AthenianLunchParser")
...
def convexUpdate():
    ...
    while(i<insertDataLength):
        ...
        if(foodStr!=prevFoodStr):
            ...
            client.mutation("groups:addItem", dict(food=foodStr, kitchen=kitchenStr))
        i=i+1
...
def main():
    ...
    with open('/data/file.pdf', 'wb') as fp:
        writer.write(fp)
    vol.commit()

    pdf_path = "/data/AthenianLunchMenu.pdf"
